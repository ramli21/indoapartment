...
@section('content')
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_tower" id="nama_tower" value="{{ old('nama_tower') }}"
                                    required
                                    class="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-sm text-slate-700 outline-none focus:border-brand focus:ring-2 focus:ring-brand/10 transition-all placeholder:text-slate-400"
                            ...
                            <!-- Nomor Kamar -->
                            <div>
                                <label for="nomor_kamar" class="block text-sm font-medium text-slate-700 mb-2">Nomor
                            ...
                            <div>
                                <label for="jumlah_kamar_mandi"
                                    class="block text-sm font-medium text-slate-700 mb-2">Jumlah Kamar
                                    Mandi <span class="text-red-500">*</span></label>
    ...
    <script>
            ...
            const dz = new Dropzone(dropzoneEl, {
                ...
                init: function() {
                    this.on('sending', function(file, xhr, formData) {
                        // room_id belum ada saat create, maka pakai placeholder 0
        ...
        // fallback: jika user klik submit tanpa gambar_json terisi, gambar_json tetap array []
    </script>
@endsection
