...
<footer class="bg-slate-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 pt-16 pb-8">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
            <!-- Brand -->
            <div class="col-span-2 md:col-span-4 lg:col-span-2 mb-4 lg:mb-0">
                <a href="#" class="flex items-center gap-2 mb-4">
                    <div class="w-8 h-8  rounded-lg flex items-center justify-center">
                        <img src="{{ asset('apple-touch-icon.png') }}" />
                    </div>
                    <span class="text-xl font-semibold text-white">IndoApart</span>
                </a>
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    ...
                    <li><a href="#"
                            class="text-slate-400 text-sm hover:text-white transition-colors">Penerbangan</a></li>
                    <li><a href="#"
                            class="text-slate-400 text-sm hover:text-white transition-colors">Aktivitas</a></li> --}}
                </ul>
            </div>
            <div>
        ...
        <div class="border-t border-white/10 pt-8 mb-8">
            <p class="text-xs text-slate-500 mb-3">Metode Pembayaran</p>
            <div class="flex flex-wrap gap-3">
                <div
                    class="px-3 py-1.5 bg-white/5 rounded-md border border-white/10 text-[11px] text-slate-400 font-medium">
                    VISA</div>
                <div
                    class="px-3 py-1.5 bg-white/5 rounded-md border border-white/10 text-[11px] text-slate-400 font-medium">
                    Mastercard</div>
        ...
        <div class="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-4">
                ...
                <span class="text-xs text-slate-500">Mata Uang: IDR</span>
            </div>
        </div>
    </div>
</footer>
